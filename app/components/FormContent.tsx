...
// interface sharePageProp {
//   handleClose: () => void | MouseEventHandler<HTMLButtonElement> | undefined;
// }


// export default function SharePage({ handleClose }: sharePageProp) {
...
//               // addCard();
//               state.ifSuccessfullyAdded ? handleClose : undefined
//             })(evt);
//           }}
//         >
...
//             type="submit"
//             className="mt-3 justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
//             onClick={state.ifSuccessfullyAdded ? handleClose : undefined}
//           >
//             Add Card
//           </Button>
//         </form>
